...
export function addOnlyNumbersInArray1(arr1: number[] | string[]): number | string {
    return arr1.reduce<number>((accumulator, currentValue) => accumulator + Number(currentValue), 0);
}

const arrayString1: string[] = ['1', '2', '3', '4', '5'];
const arrayNumbers1: number[] = [1, 2, 3, 4, 5];

const sumString1 = addOnlyNumbersInArray1(arrayString1);
const sumNumber1 = addOnlyNumbersInArray1(arrayNumbers1);
...
function addElementsInArray(arr1: (number | string)[]): number | string {
